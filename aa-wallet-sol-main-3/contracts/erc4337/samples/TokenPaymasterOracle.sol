 ...
 */
contract TokenPaymasterOracle is BasePaymaster, ERC20 {
    ...
    function getTokenValueOfEth(uint256 valueEth) internal view virtual returns (uint256 valueToken) {
        //        return valueEth / 100;
        require(oracle != NULL_ORACLE, "TokenPaymaster: unsupported token");
        return oracle.getTokenValueOfEth(valueEth);
    }
